        ...
        <div className="grid grid-cols-1 lg:grid-cols-6 gap-12 mb-16 pb-16 border-b border-gray-800/80">
          ...
          <div className="col-span-1 lg:col-span-2">
            ...
            <p className="text-gray-400 mt-6 text-sm leading-relaxed">
              Discover high-quality products at Zelecut. Shop with
            ...
            <div className="mt-8 flex flex-col space-y-4">
              ...
              <div className="flex items-center">
                <Mail
                  ...
                  className="text-indigo-400 mr-3 flex-shrink-0"
                />
                <p className="text-sm text-gray-400">support@zelecut.com</p>
              </div>
            </div>
                ...
                {[
                  {
                    ...
                    name: "Facebook",
                    bg: "bg-blue-600",
                    href: "https://facebook.com/zelecut",
                  },
                  {
                    icon: <Twitter size={18} />,
                    name: "Twitter",
                    bg: "bg-sky-500",
                    href: "https://twitter.com/zelecut",
                  },
                  {
                    icon: <Instagram size={18} />,
                    name: "Instagram",
                    bg: "bg-pink-600",
                    href: "https://instagram.com/zelecut",
                  },
                  {
                    icon: <Youtube size={18} />,
                    name: "YouTube",
                    bg: "bg-red-600",
                    href: "https://youtube.com/zelecut",
                  },
                ].map((social, idx) => (
                  <a
                    key={idx}
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col md:flex-row text-center md:text-left items-center space-y-2 md:space-y-0 md:space-x-8 text-sm">
            <p className="text-gray-400">
              © {currentYear} Zelecut. All rights reserved.
            </p>
