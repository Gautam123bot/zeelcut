const emailVerificationTemplate = (emailVerificationToken: string) => {
  ...
  return `
            ...
            <head>
                ...
                <title>Verify Your Email - Zeelcut</title>
                <style>
                    body {
            ...
            <body>
                <div class="container">
                    ...
                    <div class="content">
                        <p>Welcome to <strong>Zeelcut</strong>! To complete your registration, please use the verification code below.</p>
                        <div class="code-container">${formattedCode}</div>
                        <p>If you didn’t request this, you can safely ignore this email.</p>
                    </div>
                    <div class="footer">
                        &copy; ${new Date().getFullYear()} Zeelcut. All rights reserved.
                    </div>
                </div>
            </body>
            </html>
